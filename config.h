 ...
 */
const float mousescrollincrement = -0.05;
static MouseShortcut mshortcuts[] = {
	/* mask                 button   function        argument       release */
	{ XK_ANY_MOD,           Button4, kscrollup,      {.f = mousescrollincrement},		0, /* !alt */ -1 },
	{ XK_ANY_MOD,           Button5, kscrolldown,    {.f = mousescrollincrement},		0, /* !alt */ -1 },
...
static Shortcut shortcuts[] = {
	...
	{ MODKEY | ShiftMask,   XK_K,           kscrollup,      {.f = -0.5} },
	{ MODKEY | ShiftMask,   XK_J,           kscrolldown,    {.f = -0.5} },
	{ TERMMOD,              XK_I,           iso14755,       {.i =  0} },
	{ TERMMOD,              XK_K,           kscrollup,      {.f = 1.0} },
	{ TERMMOD,              XK_J,           kscrolldown,    {.f = 1.0} },
};
